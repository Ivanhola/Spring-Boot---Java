...
this is an extension from our previous Dependency Injection Coach app, and implements Setter injection 
...
'myFortune' bean, and implements it into our Setter Injection in each coach class*/

/*Whats new in this program vs the other:
    - Added Cricket Coach Class.
    - Created Setter methods for Coach class
    - Added Property function in our xml file*/
